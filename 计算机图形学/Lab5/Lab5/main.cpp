...
void init(GLFWwindow* window) {
	...
	renderingProgramCubeMap = Utils::createShaderProgram("vertShader2.glsl", "fragShader2.glsl");
	
	cameraX = 0.00f; cameraY = 0.1f; cameraZ = 0.5f;
...
void display(GLFWwindow* window, double currentTime) {
	...
	float angle = rotationSpeed * currentTime;
	glm::mat4 rotMat = glm::rotate(glm::mat4(1.0f), angle, glm::vec3(0.0f, 1.0f, 0.0f));
	glm::mat4 transMat = glm::translate(glm::mat4(1.0f), glm::vec3(-cameraX, -cameraY, -cameraZ));
	vMat = transMat;
	vLoc = glGetUniformLocation(renderingProgramCubeMap, "v_matrix");
	
	glm::mat4 skyboxViewMat = rotMat * glm::mat4(glm::mat3(vMat));
	glUniformMatrix4fv(vLoc, 1, GL_FALSE, glm::value_ptr(skyboxViewMat));
...
int main(void) {
	...
	GLFWwindow* window = glfwCreateWindow(800, 800, "heightMappedTerrain", NULL, NULL);
