...
GLuint globalAmbLoc2, ambLoc2, diffLoc2, specLoc2, posLoc2;

int width, height;
float aspect;
glm::mat4 pMat, vMat, mMat, mvMat, invTrMat, rMat;
glm::vec3 currentLightPos, currentLightPos2, transformed;
float lightPos[3];
float lightPos2[3];
...
int main(void) {
	...
	GLFWwindow* window = glfwCreateWindow(800, 800, "Lab 4", NULL, NULL);
